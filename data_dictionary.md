...
### Table: `dim_fund`
Stores the descriptive catalog of all mutual fund schemes.
...
| `category` | TEXT | None | Broad asset class |
| `sub_category` | TEXT | None | Specific investment strategy grouping |
| `risk_grade` | TEXT | None | Volatility classification metric |
...
Store the quantitative, measurable events and metrics. 
### Table: `fact_nav`
...
| `city_tier` | TEXT | None | Classification of the city  |
...
| `payment_mode` | TEXT | None | Method of transaction funding  |
